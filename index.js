...
var author$project$Main$renderTag = function (tagName) {
	return A2(
...
var author$project$Main$viewTags = function (tags) {
	var renderedTags = A2(elm$core$List$map, author$project$Main$renderTag, tags);
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
...
var author$project$Main$main = function () {
	...
	return A2(
		...
		_List_fromArray(
			[
				author$project$Main$viewTags(tags)
			]));
}();
